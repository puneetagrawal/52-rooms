...
ActiveRecord::Schema.define(:version => 20130130055226) do
  ...
  create_table "hotel_date_prices", :force => true do |t|
    t.date     "date"
    t.float    "price"
  ...
  create_table "spree_products", :force => true do |t|
    ...
    t.text     "amenities_html"
    t.string   "product_type"
    t.string   "supplier_name"
    t.string   "type_of_hotel"
    t.string   "type_of_holiday"
    t.time     "checkin_time"
    t.time     "checkout_time"
    t.string   "coupon_type"
    t.integer  "coupon_cost_price"
    t.string   "coupon_sale_price"
